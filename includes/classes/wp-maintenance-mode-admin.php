  ...
  class WP_Maintenance_Mode_Admin
  {
    ...
    public function enqueue_admin_styles()
    {
      ...
      if ($this->plugin_screen_hook_suffix == $screen->id) {
        ...
        wp_enqueue_style($this->plugin_slug . '-admin-jquery-ui-styles', '//ajax.googleapis.com/ajax/libs/jqueryui/' . (!empty($ui->ver) ? $ui->ver : '1.11.4') . '/themes/smoothness/jquery-ui' . WEBPR_MM__ASSETS_SUFFIX . '.css', array(), WP_Maintenance_Mode::VERSION);
        wp_enqueue_style($this->plugin_slug . '-admin-chosen', WEBPR_MM__CSS_URL . 'chosen' . WEBPR_MM__ASSETS_SUFFIX . '.css', array(), WP_Maintenance_Mode::VERSION);
        wp_enqueue_style($this->plugin_slug . '-admin-timepicker-addon-script', WEBPR_MM__CSS_URL . 'jquery-ui-timepicker-addon' . WEBPR_MM__ASSETS_SUFFIX . '.css', array(), WP_Maintenance_Mode::VERSION);
        wp_enqueue_style($this->plugin_slug . '-admin-styles', WEBPR_MM__CSS_URL . 'style-admin' . WEBPR_MM__ASSETS_SUFFIX . '.css', array('wp-color-picker'), WP_Maintenance_Mode::VERSION);
      }
    }
    ...
    public function enqueue_admin_scripts()
    {
      ...
      wp_enqueue_script($this->plugin_slug . '-admin-global', WEBPR_MM__JS_URL . 'scripts-admin-global' . WEBPR_MM__ASSETS_SUFFIX . '.js', array('jquery'), WP_Maintenance_Mode::VERSION);
    }
    ...
    public function display_plugin_settings()
    {
      ...
      // show settings
      include_once WEBPR_MM__VIEWS_PATH . 'settings.php';
    }
    ...
    public function add_notices()
    {
      ...
      if ($this->plugin_screen_hook_suffix != $screen->id) {
        ...
        ob_start();
        include_once WEBPR_MM__VIEWS_PATH . 'promo-strictthemes.php';
      ...
      // template
      include_once WEBPR_MM__VIEWS_PATH . 'notice.php';
    }
